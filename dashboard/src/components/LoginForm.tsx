  ...
  return (
    ...
    >
      <div class="flex gap-2">
        ...
        <button
          class={`btn btn-sm ${mode === 'register' ? 'btn-primary' : 'btn-ghost'}`}
      ...
      <div>
        ...
        <input
          ...
          class="w-full bg-slate-950 border border-slate-700 rounded-md px-3 py-2 text-sm"
          value={email}
      ...
      <button
        ...
        type="submit"
      >
        {mode === 'register' ? 'Creer / Remplacer le compte admin' : 'Connexion'}
      </button>
