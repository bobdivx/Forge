...
export default function ReportsFromOpenClaw() {
  ...
  if (loading) return <p class="text-slate-500 animate-pulse py-12 text-center">Chargement des rapports…</p>;
  if (reports.length === 0) return <p class="text-slate-500">Aucun contenu.</p>;
