...
export async function getMissionBoardOverview(): Promise<MissionBoardOverview> {
  ...
  // ⚡ Bolt Optimization:
  // Refactored 5 sequential database queries into a single concurrent Promise.all() block.
  // This reduces the total I/O wait time to the duration of the longest query
  // rather than the sum of all 5 queries (~75% reduction in DB blocking time).
