...
export default function AppServerLogs({
  appName,
  serverId,
  serverLabel,
  onClose,
  ...
  return (
    ...
    >
      <div
        class="w-full max-w-5xl bg-gray-950 rounded-2xl shadow-2xl border border-gray-800 flex flex-col"
      ...
      >
        ...
        <div class="flex items-center justify-between px-4 py-3 border-b border-gray-800 gap-3 flex-wrap">
          <div class="flex items-center gap-2 min-w-0">
            ...
            <span class="text-gray-100 font-semibold text-sm truncate">
              {serverLabel}
            </span>
            {logPath && (
        ...
        <div class="px-4 py-2 border-b border-gray-800 flex items-center gap-2">
          ...
          {filter && (
            <span class="text-gray-600 text-[10px] shrink-0">
              {displayLines.length} résultat
              {displayLines.length !== 1 ? "s" : ""}
            </span>
          )}
        </div>
        ...
        <div class="flex-1 overflow-y-auto p-4 font-mono text-xs leading-5 select-text">
          ...
          {displayLines.map((line, i) => {
            ...
            const isSuccess =
              ...
              !isWarn;
            const isInfo =
              /\binfo\b|\[info\]/i.test(line) && !isError && !isWarn;
