 ...
 * Utilisée par la page Instructions (UI) ; tu peux copier-coller dans ZimaOS.
 */
...
export const FORGE_AGENT_PROTOCOL_SUMMARY =
  'Termine ta réponse par une ligne FORGE_DONE task=<id> status=completed|failed : Forge scanne ZimaOS et met à jour le carnet tout seul (plus besoin d’appeler l’API à la main).';
