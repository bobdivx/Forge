...
4. Auto-réparation : si un fichier d'identité agent est manquant dans `doc/agents`, tu le régénères avant de poursuivre.
...
- Si une mission ne crée aucune ligne dans Forge (bugs / tâches / messages), considérer l’échec de reporting et renvoyer l’agent vers `doc/FORGE_API_CONTRACT.md`.
