...
export const GET: APIRoute = async () => {
  try {
    // ⚡ Bolt Optimization: Group independent database queries in Promise.all to run concurrently.
    // Impact: Reduces wait time to the longest single query instead of sum of both.
