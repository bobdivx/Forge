...
export default function DashForgeTracker() {
  ...
  return (
    ...
    >
      ...
      <div class="absolute -right-8 -bottom-8 pointer-events-none" aria-hidden="true">
      ...
      <div class="relative z-10">
        ...
        <div class="flex justify-center gap-3">
          ...
          <a
            ...
            class="w-10 h-10 bg-red-500 text-white rounded-full flex items-center justify-center hover:bg-red-600 transition-colors shadow-lg"
