...
- THEN le texte et les extraits de chemins ne provoquent pas de débordement horizontal inuti­lisable (retour à la ligne ou scroll horizontal localisé sur `code`)
