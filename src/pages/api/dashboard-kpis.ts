...
export const GET: APIRoute = async () => {
  ...
  try {
    ...
    base.projectCount = projectsCount[0]?.value || 0;
    base.tasksTotal = tasksTotalCount[0]?.value || 0;
    base.tasksToday = tasksTodayCount[0]?.value || 0;
    base.openRequests = openRequestsCount[0]?.value || 0;
    base.openAppIssues = issuesCount[0]?.value || 0;
    base.openDependencyRequests = depsCount[0]?.value || 0;
  } catch (e) {
