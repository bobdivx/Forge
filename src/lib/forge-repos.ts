 ...
 * Si la base contient encore `/media/Github` mais le volume est monté sur `/mnt/GitHub`,
 * on utilise le premier répertoire qui existe réellement sur le FS du conteneur.
 */
