...
export default function ForgeSwarmActivities() {
  ...
  return (
    <>
      <div class="bg-slate-900/50 border border-slate-800 rounded-xl p-6 backdrop-blur-sm">
        <h3 class="font-bold text-white mb-6 border-b border-slate-800 pb-3 uppercase tracking-widest text-xs text-slate-500">Activité récente (sessions ZimaOS)</h3>
